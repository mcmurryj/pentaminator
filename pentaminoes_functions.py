"""This module contains functions for solving pentaminoes puzzles. """
        ...
        if grid[s] == 1:
            ...
            for a in angles:
                ...
                try:
                    ...
                    #Add displacement for each square of shape to the starting point on the grid.
                    ...
                    for el in x:
                        ...
                        if el.min() < 0:
                            #Give up on the pose...
                            #Is this also covered by the IndexError exception below?
                            break
                    else:
...
def place_next(pieces,
    ...
    for p in pieces[0]:
        ...
        if chunk_incompatible(superimposition):
            continue
        #If the list of pieces left to place is 1 long (you just placed a piece)
        if limit == 1:
            print("victory\n")
            for i in index_list + [p]:
                print(i)
                print('\n\n')
            print("\n\n\n\n\n\n")
        else:
